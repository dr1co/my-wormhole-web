...
export function NewMemoryForm() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        >
          <input
            ...
            id="isPublic"
            value="true"
            className="w-4 h-4 rounded border-gray-400 bg-gray-700 text-redspecial focus:ring-0"
          />
          Make memory Public
        </label>
      </div>
      ...
      <button
        type="submit"
        className="inline-block self-end rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600 transition-colors"
      >
        Save
      </button>
    </form>
